...
if (typeof jQuery === "undefined") {
  throw new Error("This website requires jQuery to work on!");
}
/* jolpaiObj
 *
 * @type Object
...
$.jolpaiObj.Typed = function(selector) {
  ...
  if ($(selector).length) {
    ...
    $(selector).typed({
      strings: ["BLAH", "Graphic Designer", "Web Developer", "Photographer"],
      typeSpeed: 10,
      loop: true,
      backDelay: 2000
    });
...
$(function() {
  ...
  //Add work related references
  // $.resume.addJobs();

  //Add service section
  // $.resume.serviceSection();
